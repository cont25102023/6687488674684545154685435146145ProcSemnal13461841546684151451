...
def toImg(Y0,m,n):
    ...
    X0=X0[:,:m,:n,:]
    X=np.zeros_like(X0)
    X[...,0]=B[0][0]*X0[...,0]+B[0][1]*X0[...,1]+B[0][2]*X0[...,2]
    X[...,1]=B[1][0]*X0[...,0]+B[1][1]*X0[...,1]+B[1][2]*X0[...,2]
    X[...,2]=B[2][0]*X0[...,0]+B[2][1]*X0[...,1]+B[2][2]*X0[...,2]
    return X
...
def JPEG2(X,Q):
    ...
    try:
        ...
        temp0[...,0]=A[0][0]*X[...,0]+A[0][1]*X[...,1]+A[0][2]*X[...,2]
        temp0[...,1]=A[1][0]*X[...,0]+A[1][1]*X[...,1]+A[1][2]*X[...,2]
        temp0[...,2]=A[2][0]*X[...,0]+A[2][1]*X[...,1]+A[2][2]*X[...,2]
        ...
        # Y este de tip rgb, comprimat jpeg:
        Y[...,0]=B[0][0]*temp1[...,0]+B[0][1]*temp1[...,1]+B[0][2]*temp1[...,2]
        Y[...,1]=B[1][0]*temp1[...,0]+B[1][1]*temp1[...,1]+B[1][2]*temp1[...,2]
        Y[...,2]=B[2][0]*temp1[...,0]+B[2][1]*temp1[...,1]+B[2][2]*temp1[...,2]
